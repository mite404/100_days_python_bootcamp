...
def play_game():
    ...
    while not is_game_over:
        # Hint 9: Call calculate_score(). If the computer or the user has a blackjack (0) or if
        ...
        # yes, then use the deal_card() function to add another card to the user_cards List. If no,
